...
<?php $ret = $this->main_model->select('spots', $cat); ?>
...
<div class="row m-0 min-h">
	...
	<div class="col-lg-10 card p-3 mt-4">
		 <?php if($ret != false){ ?>
            ...
            <h5 class="mt-2"><b>Category:</b> <?php echo $cat;?></h5>
           ...
           if($ret != false){ ?>
         	 ...
         	 <?php  }else{ ?>
         	 		...
         	 		<div class="col-lg-12">
         	 			...
         	 			<h5 class="text-center no-result">No result found for <b><?php echo $cat;?></b> tourist spot category</h5>

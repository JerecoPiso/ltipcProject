...
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/tourist_spotsss.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/establishments.js"></script>

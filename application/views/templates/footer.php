...
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/settings.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/admins.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/dashboardHomepageee.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/loginSignupppp.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/tourist_spotssssss.js"></script>
<script src="<?php echo base_url();?>assets/bootstrap_vuejs/js/establishmentttt.js"></script>
